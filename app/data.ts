...
export const mondaySignals = [
  {
    ...
    sl: "< 178",
    tp: "190-195",
    desc: "Ngeri ini barang, breakout sukses dari resist 172 yg kita bahas kemaren. Volume gajah beneran masuk. Liat orderbooknya, total bid 3 juta lot ngelawan offer yg cuma 1 juta. Bandar masang tembok tebel di 183 buat nahan support. Momentumnya lagi kenceng banget, manfaatin buat numpang narik kenceng."
  },
  {
    code: "BUVA",
    entry: "725",
    ...
    sl: "< 700",
    tp: "735-745",
    desc: "Pelan-pelan merangkak naik ngetes resist 730. Dari orderbook keliatan lebih imbang dan agak tipis dibanding BUMI. Ini geraknya rawan gocek bandar, cocok buat tektokan range sempit aja kaga usah di-hold lama-lama."
  },
  {
    code: "PACK",
    entry: "Skip Hajar Kanan", // Disingkat dikit biar muat di kotak UI
    antri: "274-276",
    sl: "< 270",
    tp: "284-288",
    desc: "Chartnya emang lagi nyungsep nurun, tpi lu pelototin orderbooknya. Ada bid wall raksasa ratusan ribu lot di harga 272. Ini murni bandar lagi masang barikade jaring pengaman biar harganya kaga makin ambyar nyari lantai baru. Kita main copet mantulan aja manfaatin tembok ini."
  },
  {
    code: "BIPI",
    entry: "185",
    ...
    sl: "< 177",
    tp: "190-195",
    desc: "Geraknya seirama mirip BUMI, wajar satu sektor lagi ditarik barengan. Chartnya breakout cakep ke 184. Liat bid wall nya, ditebelin di area 180 sampe 183. Offer atasnya kaga terlalu tebel, gampang dijebol kalo sentimen komoditas masih narik hari ini."
  },
  {
    code: "DFAM",
    entry: "141-142",
